export function MainCase() {
    return <div>
        ...
        <div className="text-8xl tracking-tighter pl-10">
            <span>You can build anything<br></br> with Tailwind CSS.</span>
        </div>
        <div className="pt-12 pl-11 border-t border-gray-200">
